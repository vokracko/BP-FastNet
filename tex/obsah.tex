...
\subsection{Třídní adresy}
Třídní adresy se dělí do čtyř skupin pojmenované písmeny abecedy.
\subsubsection{Třída A}
Třída A využívá pro adresování sítě pouze první octet, zbylé tři octety jsou použity pro adresování zařízení uvnitř takovéto sítě.
Třída A obsahuje $3 * 8 * 254$ adres pro počítače a pouze $XX$ adresy pro rozlišení sítě. Sítě, které potřebují takovéto obrovské množství počítačů nejsou reálně potřeba.

\subsubsection{Třída B}
\section{CIDR}
